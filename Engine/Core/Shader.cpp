...
ShaderMatchRule::ShaderMatchRule()
	...
	, tessCtrlFeatureMask(ShaderFeature::Shader_Feature_Mask & ~Shader_Deferred & ~Shader_Lighting & ~Shader_Postprocess)
	, tessEvalFlag(ShaderMatchFlag::Strict)
	, tessEvalFeatureMask(ShaderFeature::Shader_Feature_Mask & ~Shader_Deferred & ~Shader_Lighting & ~Shader_Postprocess)
	, geometryFlag(Enum(ShaderMatchFlag::Best) | ShaderMatchFlag::Fallback_Default)
	, geometryFeatureMask(ShaderFeature::Shader_Feature_Mask & ~Shader_Deferred & ~Shader_Lighting & ~Shader_Postprocess)
