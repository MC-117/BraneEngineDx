...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"    // warning : 'xx' is deprecated: The POSIX path for this item.. // for strdup used in demo code (so user can copy & paste the code)
...
#pragma clang diagnostic ignored "-Wreserved-id-macro"          // warning : macro path is a reserved identifier                //
#endif
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            // Using the format string to display a path instead of an integer.
            // Here we completely omit '%d' from the format string, so it'll only display a path.
